...
namespace :globalize do
  ...
  task :create_tables => :environment do
    ...
    ActiveRecord::Base.connection.add_index :globalize_countries, :code, :name => 'ix_glb_cntr_code'
    ...
    ActiveRecord::Base.connection.create_table :globalize_translations, :force => true do |t|
      ...
      t.column :built_in,               :integer#, :default => true
      t.column :language_id,            :integer
      t.column :pluralization_index,    :integer
      t.column :text,                   :text
      t.column :namespace,              :string
    end
    ActiveRecord::Base.connection.add_index :globalize_translations, [ :tr_key, :language_id ], :name => 'ix_glb_trns_key_lang'
    ActiveRecord::Base.connection.add_index :globalize_translations, [ :table_name, :item_id, :language_id ], :name => 'ix_glb_trns_tbl_itm_lang'
    ...
    ActiveRecord::Base.connection.add_index :globalize_languages, :iso_639_1, :name => 'ix_glb_lang_iso_639_1'
    ActiveRecord::Base.connection.add_index :globalize_languages, :iso_639_2, :name => 'ix_glb_lang_iso_639_2'
    ActiveRecord::Base.connection.add_index :globalize_languages, :iso_639_3, :name => 'ix_glb_lang_iso_639_3'
    ActiveRecord::Base.connection.add_index :globalize_languages, :rfc_3066, :name => 'ix_glb_lang_rfx_3066'
  end
  ...
  task :load_locale_data => :environment do
    ...
    ViewTranslation.update_all "built_in = 1" 
  end
